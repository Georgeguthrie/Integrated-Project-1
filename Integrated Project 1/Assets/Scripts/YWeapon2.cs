...
public class YWeapon2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            animator.SetBool("IsYLight", true);
            StartCoroutine(Timer());
            IEnumerator Timer()
            {
                yield return new WaitForSeconds(0.8f);
                animator.SetBool("IsYLight", false);
            }
            Light.Play();
            Shoot();
            Ammo();
        ...
        {
            animator.SetBool("IsYHeavy", true);
            StartCoroutine(Timer());
            IEnumerator Timer()
            {
                yield return new WaitForSeconds(0.8f);
                animator.SetBool("IsYHeavy", false);
            }
            Heavy.Play();
            Shoot2();
            Ammo2();
